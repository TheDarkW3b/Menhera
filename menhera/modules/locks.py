...
import menhera.modules.sql.locks_sql as sql
from menhera import dispatcher, SUDO_USERS, LOGGER
from menhera.modules.disable import DisableAbleCommandHandler
from menhera.modules.helper_funcs.chat_status import can_delete, is_user_admin, user_not_admin, user_admin, \
